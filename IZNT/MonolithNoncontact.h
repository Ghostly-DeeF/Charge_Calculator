...
private: System::Void btnTextVersion_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	textBox1->Text = "Неконтактные заряды для подрывания кирпичных, каменных, бетонных и железобетонных колонн(столбов) и балок рассчитываются по формуле :"
		"C = 10 Ahr^2 (29) \r\n"
		"где С — вес заряда в килограммах; \r\n"
		"А — коэффициент, зависящий от свойств подрываемого материала и применяемого ВВ \r\n"
		"h — толщина подрываемого элемента в метрах; \r\n"
		"r — расстояние между центром заряда и осью подрываемого элемента в метрах. \r\n"

		"Неконтактные заряды для пробивания отверстий в плитах и стенах из кирпича, камня и неармированного бетона рассчитываются по формуле(29) с увеличением в три раза."

		"При подрывании конструкций из кирпича, камняи бетона под водой контактными зарядами вес последних, определяется по ст. 147 и 148 без изменений.Контактные заряды для подрывания под водой железобетонных элементов - рассчитываются по указаниям тех же статей, но с увеличением в полтора раза.При этом заряды считаются подводными независимо от глубины их погружения в воду.Неконтактные заряды для подрывания под водой конструкций из кирпича, камня, бетона и железобетона рассчитываются по формуле(29) с уменьшением в полтора раза, если глубина погружения зарядов составляет не менее половины расчетного расстояния (расстояния от центра заряда до оси подрываемого элемента) .";
